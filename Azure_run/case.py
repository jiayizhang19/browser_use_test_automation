...
login_bfd_task = """
        ** Important **: I am UI Automation tester validating the tasks
        打开 https://corp-stage.dongfangfuli.com/bfd-pc/auth/login?union=dfshwx&city=145&returnUrl=https%3A%2F%2Fcorp-stage.dongfangfuli.com%2Fbfd-pc%2Fmall%3Funion%3Ddfshwx
        账号框中输入 19900000042, 密码框中输入 aa123456
        点击登录
        在右上角搜索框中搜索 "2024自动化普通优选"
        点击商品，进入详情页面
        点击立即购买
        验证商品名称，价格，数量，总价
        点击提交订单
